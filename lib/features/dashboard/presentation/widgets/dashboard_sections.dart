...
List<BoxShadow> dashboardCardShadow() {
  return [
    BoxShadow(
...
class DashboardStatusCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      (
        l10n.dashboardCardAttendanceStatus,
...
class DashboardServicesPanel extends StatelessWidget {
  const DashboardServicesPanel({
    ...
    required this.onWeListenTap,
  });

  final AppLocalizations l10n;
  final void Function(String route) onRouteTap;
  final VoidCallback onWeListenTap;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          _ServicesGrid(l10n: l10n, onTap: onRouteTap),
          const SizedBox(height: 16),
          _WeListenButton(title: l10n.svcWeListen, onTap: onWeListenTap),
        ],
      ),
    );
  }
...
class DashboardAnnouncementsPanel extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return _AnnouncementsHomePanel(
      l10n: l10n,
                        ...
                        Expanded(
                          child: Center(
                            child: FittedBox(
                              ...
                              child: _QuickCardTitleLines(title: title),
                            ),
                          ),
                        ),
                      ],
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Icon(chevron, color: const Color(0xFF9AA5B1), size: 20),
                  ],
                ),
              ),
            ),
...
class _ServicesGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final entries = <(String title, IconData icon, String route)>[
      ...
      (
        l10n.dashboardGridLeaveMgmt,
        Icons.event_note_outlined,
        AppRoutes.formLeave,
      ),
      (
        l10n.dashboardGridManager,
        Icons.badge_outlined,
        AppRoutes.managerialApprovals,
      ),
    ];
